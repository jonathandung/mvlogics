...
@overload
def t_norm_logic(*, name: str, rational: Literal[True], **additional: object) -> Callable[[Callable[[Fraction, Fraction], Fraction]], type[RationalTNormLogic]]: ...
@overload
def t_norm_logic(*, rational: Literal[False]=..., **additional: object) -> Callable[[Callable[[Decimal, Decimal], Decimal]], type[TNormLogic]]: ...
@overload
def t_norm_logic(*, rational: Literal[True], **additional: object) -> Callable[[Callable[[Fraction, Fraction], Fraction]], type[RationalTNormLogic]]:  '''A decorator factory whose products return t-norm logic classes given the strong conjunction operator, given whether the members should be constrained to rational numbers.'''
@overload
def logic_from_implication(*, name: str, rational: Literal[False]=..., **additional: object) -> Callable[[Callable[[Decimal, Decimal], Decimal]], type[DecimalLogicBase]]: ...
@overload
def logic_from_implication(*, name: str, rational: Literal[True], **additional: object) -> Callable[[Callable[[Fraction, Fraction], Fraction]], type[RationalLogicBase]]: ...
@overload
