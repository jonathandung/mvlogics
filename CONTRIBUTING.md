...
Please note we have a [code of conduct](https://github.com/jonathandung/mvlogics/blob/main/CODE_OF_CONDUCT.md). Please follow it in all your
...
project owner. The versioning scheme we use is [SemVer](https://semver.org), but we currently only have major, minor and patch parts for simplicity.
