...
However, if you do not want to do so for any reason, note the following:
...
- This is considered bad practice, and we are not accountable for unexpected behaviour in the resultant class.

Besides, follow the template below:
